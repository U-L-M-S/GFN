...
reference: "[[Ecc RAM ]]"
path: Notes
created: 2023-10-09 17:21
modified: 2023-10-09 17:21
---
## Hamming Code 

Hamming-Code oder besser gesagt (7,4)-Hamming-Code ist ein Code bei den Daten (Nachricht) gesendet wird + eine Prüfsumme. 
Die Prüfsumme  ist nur da zu überprüfen ob ein Bit-Fehler (Bitinvertierung) passiert ist.
 
 Die ersten 4 Bits sind die Nachricht und die letzen 3 sind die Prüfbits.
$x_{1}$ = 0
$x_{2}$ = 0
$x_{3}$ = 1
$x_{4}$ = 1
...
$x_{7}$ = 1
 ...
 | ------- | ------- | ------- | ------- | ------- | ------- | ------- |
 | 0       | 0       | 1       | 1       | <mark style="background: #FF5582A6;">1</mark>       | <mark style="background: #BBFABBA6;">0</mark>       | <mark style="background: #BBFABBA6;">1</mark>        |
